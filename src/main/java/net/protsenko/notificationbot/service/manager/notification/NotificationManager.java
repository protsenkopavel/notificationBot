...
import net.protsenko.notificationbot.service.manager.notification.NotificationContainer;
...
public class NotificationManager extends AbstractManager
    ...
    private BotApiMethod<?> editTime(Message message, User user, Bot bot) {
        ...
        if (pattern.matches()) {
            ...
            long seconds = Long.parseLong(nums[0]) * 3600 + Long.parseLong(nums[1]) * 60 + Integer.parseInt(nums[2]);
